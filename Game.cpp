...
namespace tw
{
	...
	void Game::OnEvent(sf::Event e)
	{
		if (e.type == sf::Event::KeyPressed) 
		{
			...
			if(kc == sf::Keyboard::Left || kc == sf::Keyboard::A) // ruch w lewo
			{
				move(-1, 0);
			}	
			else if(kc == sf::Keyboard::Right || kc == sf::Keyboard::D) // ruch w prawo
			{
				move(1, 0);
			}
			else if(kc == sf::Keyboard::Up || kc == sf::Keyboard::W) // ruch w gore
			{
				move(0, -1);
			}
			else if(kc == sf::Keyboard::Down || kc == sf::Keyboard::S) // ruch w dol
			{
				move(0, 1);
			}
		}
